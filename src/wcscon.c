...
#include <string.h>
/* #include "wcs.h" */
#include "wcs_defines.h"
#include "wcscon.h"
#include "slasub.c"
/* added : because I could not find the difference between strsrch and strstr*/
#define strsrch(A,B) strstr(A,B)
...
#ifdef DO_NOT_NEED_IT
void
wcsconp (int sys1, int sys2, double eq1, double eq2, double ep1, double ep2, double *dtheta, double *dphi, double *ptheta, double *pphi)
...
void
wcscstr (char *cstr, int syswcs, double equinox, double epoch)
#ifdef OLD_STUFF
...
void
fk42gal (double *dtheta, double *dphi)
#ifdef OLD_STUFF
...
void
gal2fk4 (double *dtheta, double *dphi)
#ifdef OLD_STUFF
...
void
fk52gal (double *dtheta, double *dphi)
#ifdef OLD_STUFF
...
void
gal2fk5 (double *dtheta, double *dphi)
#ifdef OLD_STUFF
double *dtheta;	/* Galactic longitude (l2) in degrees
...
void
jpcon (double pos[3],double *rra,double *rdec, double *r)
#ifdef OLD_STUFF
...
void
jpcop (double rra, double rdec, double r, double pos[3])
#ifdef OLD_STUFF
double rra;	/* Right ascension in radians */
double rdec;	/* Declination in radians */
double r;	/* Distance to object in same units as pos */
...
void
fk52ecl (double *dtheta, double *dphi, double epoch);
...
void
fk42ecl (double *dtheta, double *dphi, double epoch)
#ifdef OLD_STUFF
...
void
ecl2fk4 (double *dtheta, double *dphi, double epoch)
#ifdef OLD_STUFF
double *dtheta;	/* Galactic longitude (l2) in degrees
...
void
fk4prec (double ep0, double ep1, double *ra, double *dec)
#ifdef OLD_STUFF
...
void mprecfk5 (double ep0, double ep1, double rmatp[3][3])
#ifdef OLD_STUFF
...
void
fk5prec (double ep0, double ep1, double *ra, double *dec)
#ifdef OLD_STUFF
...
void
mprecfk4 (double bep0, double bep1, double rmatp[3][3])
#ifdef OLD_STUFF
