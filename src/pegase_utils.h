...
string * PegaseKeys(int & N, bool with_u, bool with_BV, bool first_sol=false);
...
void WritePegaseInFile(string file_name, DictFile & peg_infile,  bool with_u , bool with_BV, bool is_host_list, bool use_AB=false);
// to read the out file in a DictFile
void ReadPegaseOutFile(string file_name, DictFile & peg_outfile, bool & with_u ,  bool & with_BV, bool oui_append = false);
