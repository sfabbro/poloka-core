...
void
slaDeuler (char *order, double phi, double theta, double psi, double rmat[3][3])
#ifdef OLD_STUFF
...
{
   int j, i, l, n, k;
   double result[3][3], rotn[3][3], s, c , w, wm[3][3];
   double angles[3];
   char axis;
