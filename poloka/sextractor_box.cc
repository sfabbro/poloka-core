...
#undef OFF_T
#endif
#include <sextractor/define.h> /* from sextractor, mandatory for next one () */
#include <sextractor/globals.h> /* from sextractor. nice name isn't it ? */
#include <sextractor/types.h> 
#include <sextractor/prefs.h> // a ajouter pour la version v244
#include <sextractor/back.h> 
}
