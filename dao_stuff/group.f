...
C
      ...
      REAL CRITSQ, CRITSEP, DXTEST, DYTEST, RATIO, ERR, GLOBAL_SKY
...
C  950 CALL GETNAM ('File with photometry:', MAGFIL)
...
C
C  960 CALL GETNAM ('File with the PSF:', PSFFIL)
...
C  970 CALL GETNAM ('File for stellar groups:', GRPFIL)
...
C
      ERR=RONOIS+0.5*(STEST+SKY(J)+GLOBAL_SKY)/PHPADU
C
