...
C Variables
C
      CHARACTER*256 COOFIL, MAGFIL, PSFFIL, PROFIL, GRPFIL, CONPIC
 ...
 4000 IF (WATCH .LE. 0.5) WRITE (6,640) NSTAR
  ...
  642 FORMAT(/' Your old threshold was', F8.2, ' sigma =',
     .     F8.2, ' ADU.'/)
      ...
      IF (OPT(6) .LT. -1.E30) GO TO 9000             ! CTRL-Z was entered
C 4030 CALL GETNAM ('Output file name:', COOFIL)
C      IF ((COOFIL .EQ. 'END-OF-FILE') .OR. 
C     .     (COOFIL .EQ. 'GIVE UP')) THEN
C         COOFIL = ' '
C         GO TO 9000
